...
public class DayThree {
    public static void main(String[] args) {
        ...
        Logger.print(timer, "Consumption", calculateConsumption(new File("src/AOC2021/Resources/DayThree.txt")));
        Logger.print(timer, "Life support rating", calculateLifeSupportRating(new File("src/AOC2021/Resources/DayThree.txt")));
    }
